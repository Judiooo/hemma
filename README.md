...
Hemma may use service icons from third-party icon collections, including [Dashboard Icons](https://github.com/homarr-labs/dashboard-icons) and [Simple Icons](https://simpleicons.org/).
