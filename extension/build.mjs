...
appJs = appJs.replaceAll("'/icons/", "'icons/").replaceAll('"/icons/', '"icons/').replaceAll("`/icons/", "`icons/").replaceAll("'/wallpaper/", "'wallpaper/").replaceAll('"/wallpaper/', '"wallpaper/').replaceAll("`/wallpaper/", "`wallpaper/");
